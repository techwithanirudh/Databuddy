 ...
 */
export function createScreenResolutionsBuilder(
	websiteId: string,
	startDate: string,
	endDate: string,
	limit = 10,
 ...
 */
export function createBrowserVersionsBuilder(
	websiteId: string,
	startDate: string,
	endDate: string,
	limit = 10,
	...
	builder.sb.where = {
		...
		event_filter: "event_name = 'screen_view'",
		browser_filter:
			"browser_name IS NOT NULL AND browser_name != 'Unknown' AND browser_name != ''",
	};
 ...
 */
export function createDeviceTypesBuilder(
	websiteId: string,
	startDate: string,
	endDate: string,
	limit = 5,
 ...
 */
export function createConnectionTypesBuilder(
	websiteId: string,
	startDate: string,
	endDate: string,
	limit = 10,
 ...
 */
export function formatDeviceData(
	deviceData: Array<{
		device_type: string;
		device_brand: string;
		device_model: string;
