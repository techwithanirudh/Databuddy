...
export function createStreamingResponse(updates: AsyncGenerator<StreamingUpdate>): Response {
...
export async function* generateThinkingSteps(steps: string[]): AsyncGenerator<StreamingUpdate> {
