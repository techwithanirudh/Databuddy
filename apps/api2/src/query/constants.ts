...
export const QUERY_CATEGORIES = {
    ...
    pages: {
        ...
        queries: ["top_pages", "page_details", "entry_pages", "exit_pages", "page_time_series"] as const
    },
    traffic: {
        name: "Traffic Sources",
        description: "Referrer and UTM campaign analysis",
        queries: ["top_referrers", "utm_sources", "utm_mediums", "utm_campaigns", "referrer_types", "referrer_domains"] as const
    },
    devices: {
        name: "Devices & Browsers",
        description: "Device type, browser, and OS analytics",
        queries: ["device_types", "browsers", "browser_versions", "operating_systems", "os_versions", "screen_resolutions"] as const
    },
    geo: {
        name: "Geographic",
    ...
    errors: {
        ...
        queries: ["recent_errors", "error_types", "error_trends", "errors_by_page", "error_frequency"] as const
    },
    performance: {
        name: "Performance",
        description: "Page load time and performance metrics",
        queries: ["performance_metrics", "slow_pages", "performance_by_device", "performance_by_browser", "performance_time_series"] as const
    },
    sessions: {
        name: "Sessions",
        description: "Session analytics and user behavior",
        queries: ["session_metrics", "session_duration_distribution", "sessions_by_device", "sessions_by_browser", "sessions_time_series", "session_flow"] as const
    },
    custom_events: {
        name: "Custom Events",
        description: "Custom event tracking and analysis",
        queries: ["custom_events", "custom_event_details", "custom_event_trends", "custom_event_by_page"] as const
    }
} as const;
