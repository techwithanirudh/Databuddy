...
export const analyticsEventSchema = z.object({
    ...
    anonymousId: z.templateLiteral([z.literal("anon_"), z.string().max(32)]).nullable().optional(),
    sessionId: z.templateLiteral([z.literal("sess_"), z.string().max(32)]).nullable().optional(),
