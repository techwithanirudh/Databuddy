			...
			<CardContent className="flex flex-col items-center justify-center px-8 py-16">
				...
				<div className="max-w-md space-y-4 text-center">
					...
					<p className="text-muted-foreground leading-relaxed">
						Connect your databases to start monitoring performance, tracking
						queries, and gaining insights into your database health across all
						environments.
					</p>
					<div className="pt-2">
						<Button
							className={cn(
								'gap-2 rounded px-8 py-4 font-medium text-base',
