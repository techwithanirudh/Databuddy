    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="hidden w-56 flex-shrink-0 border-r p-4 pr-6 sm:block">
          <SettingsSidebar activeTab={activeTab} items={tabs} setActiveTab={setActiveTab} />
        </aside>
          ...
          {activeTab === "account" && (
            <Card className="shadow-sm">
              ...
              <CardContent className="flex flex-col gap-8">
                <div>
                  <h3 className="font-semibold text-lg tracking-tight">Email Address</h3>
                ...
                <div className="border-t pt-8">
                  <h3 className="font-semibold text-lg tracking-tight">Password</h3>
                  <p className="text-sm text-muted-foreground mt-1">
                ...
                <div className="border-t pt-8">
                  <h3 className="font-semibold text-lg tracking-tight">Timezone</h3>
                  <p className="text-sm text-muted-foreground mt-1">
                ...
                <div className="border-t border-destructive/50 pt-8">
                  <h3 className="font-semibold text-lg tracking-tight text-destructive">
                    Delete Account
                  </h3>
                  <p className="text-sm text-muted-foreground mt-1">
          ...
          {activeTab === "security" && (
            <Card className="shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Manage your account's security, including two-factor authentication and
                  active sessions.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-8">
                ...
                <div className="border-t pt-8">
                  <h3 className="font-semibold text-lg tracking-tight">Active Sessions</h3>
                  <p className="text-sm text-muted-foreground mt-1">
