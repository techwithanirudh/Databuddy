    ...
    return (
      <div className="flex h-full items-center justify-center rounded-lg border bg-muted/20 p-6 shadow-sm">
        <div className="text-center">
          <BugIcon className="mx-auto h-8 w-8 text-muted-foreground" size={16} weight="duotone" />
          <h3 className="mt-2 font-medium text-muted-foreground text-sm">No error trend data</h3>
    ...
    <div className="flex h-full flex-col rounded-lg border shadow-sm">
      <div className="flex items-center justify-between border-b p-4">
        <div>
          ...
          <p className="text-muted-foreground text-xs">Error occurrences and impact over time</p>
        </div>
        {errorChartData.length > 5 && (
          <div className="flex items-center gap-2">
            {isZoomed && (
              <Button className="h-7 px-2 text-xs" onClick={resetZoom} size="sm" variant="outline">
                <ArrowCounterClockwiseIcon className="mr-1 h-3 w-3" size={16} weight="duotone" />
                Reset Zoom
              </Button>
            )}
      ...
      <div className="flex-1 p-2">
        <div style={{ width: "100%", height: 300 }}>
          <ResponsiveContainer height="100%" width="100%">
            ...
            >
              <defs>
                <linearGradient id="colorTotalErrors" x1="0" x2="0" y1="0" y2="1">
                  <stop offset="5%" stopColor="#ef4444" stopOpacity={0.25} />
                  <stop offset="95%" stopColor="#ef4444" stopOpacity={0.05} />
                </linearGradient>
                <linearGradient id="colorAffectedUsers" x1="0" x2="0" y1="0" y2="1">
