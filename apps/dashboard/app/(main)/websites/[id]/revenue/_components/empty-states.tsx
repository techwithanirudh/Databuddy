...
import { CurrencyDollarIcon, PlusIcon, WarningCircleIcon } from "@phosphor-icons/react";
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="rounded-full border border-orange-200 bg-orange-100 p-4 dark:border-orange-800 dark:bg-orange-900/20">
            <WarningCircleIcon className="h-8 w-8 text-orange-500" size={32} weight="duotone" />
          </div>
          <div>
            ...
            <p className="mt-2 max-w-md text-orange-700 text-sm dark:text-orange-300">
              Configure your Stripe webhook integration to start tracking revenue for{" "}
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="rounded-full border border-blue-200 bg-blue-100 p-4 dark:border-blue-800 dark:bg-blue-900/20">
            <CurrencyDollarIcon className="h-8 w-8 text-blue-500" size={32} weight="duotone" />
          </div>
          <div>
            ...
            <p className="mt-2 max-w-md text-blue-700 text-sm dark:text-blue-300">
              No revenue has been recorded for {websiteName || "this website"} in the selected time
              period. Make sure your Stripe checkout includes the correct client_id and session_id.
            </p>
          </div>
