...
export function useWebsiteTransfer(organizationId: string) {
    ...
    const transferMutation = useMutation({
        mutationFn: ({ websiteId, destination }: { websiteId: string, destination: { organizationId?: string | null } }) =>
...
const transferApi = {
    ...
    transfer: async (websiteId: string, destination: { organizationId?: string | null }): Promise<{ success: boolean }> => {
