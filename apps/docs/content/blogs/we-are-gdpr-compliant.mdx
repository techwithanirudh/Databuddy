...
<div className="grid md:grid-cols-2 gap-6 my-8">
  <div className="p-6 border rounded-lg bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800">
    <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-200">✅ What This Means</h3>
  ...
  <div className="p-6 border rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800">
    <h3 className="text-lg font-semibold mb-2 text-blue-800 dark:text-blue-200">🚀 Immediate Benefits</h3>
...
<Tabs items={['Right to Information', 'Right to Access', 'Right to Deletion', 'Right to Portability']}>
  <Tab value="Right to Information">
    ### 📋 Transparent Data Practices
    
    Users can access our comprehensive [Privacy Policy](/privacy) which clearly explains:
...
<Steps>
  <Step>
    **Sign Up** - Create your free account at [app.databuddy.cc](https://app.databuddy.cc/register)
  </Step>
  <Step>
...
<div className="grid md:grid-cols-4 gap-4 my-8">
  <div className="text-center p-6 border rounded-lg bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800">
    ...
    <div className="text-sm text-purple-700 dark:text-purple-300">Cookies Used</div>
  </div>
  <div className="text-center p-6 border rounded-lg bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800">
    ...
    <div className="text-sm text-green-700 dark:text-green-300">Consent Banners</div>
  </div>
  <div className="text-center p-6 border rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800">
    ...
    <div className="text-sm text-blue-700 dark:text-blue-300">GDPR Compliant</div>
  </div>
  <div className="text-center p-6 border rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border-orange-200 dark:border-orange-800">
    <div className="text-3xl font-bold text-orange-600 dark:text-orange-400">65x</div>
    <div className="text-sm text-orange-700 dark:text-orange-300">Faster than GA</div>
  </div>
</div>
...
<Cards>
  <Card 
    ...
    description="Get started in under 2 minutes. No credit card required, no consent banners needed."
  />
  <Card 
    href="/demo"
    title="📊 View Live Demo" 
    description="See Databuddy in action with real analytics data and features."
  />
  <Card 
    href="https://discord.gg/JTk7a38tCZ"
    title="💬 Join Community" 
    description="Connect with other privacy-first developers and get expert support."
  />
</Cards>
...
<div className="grid md:grid-cols-2 gap-4 my-6">
  <div className="space-y-3">
    <div className="flex items-center gap-3 p-3 rounded-lg border border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/50">
      ...
      <span className="text-sm font-medium">**Full GDPR compliance** out of the box</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/50">
      ...
      <span className="text-sm font-medium">**Zero cookies** and no consent banners</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-950/50">
      ...
      <span className="text-sm font-medium">**EU data residency** for enhanced protection</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-orange-200 dark:border-orange-800 bg-orange-50/50 dark:bg-orange-950/50">
      ...
      <span className="text-sm font-medium">**Complete user privacy** with actionable insights</span>
    </div>
  </div>
  <div className="space-y-3">
    <div className="flex items-center gap-3 p-3 rounded-lg border border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/50">
      <span className="text-green-600 dark:text-green-400 text-xl">⚡</span>
      <span className="text-sm font-medium">**Lightning-fast performance** for better UX</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/50">
      <span className="text-blue-600 dark:text-blue-400 text-xl">🌍</span>
      <span className="text-sm font-medium">**Future-proof compliance** for global regulations</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-950/50">
      <span className="text-purple-600 dark:text-purple-400 text-xl">👨‍💻</span>
      <span className="text-sm font-medium">**Expert support** from privacy-first specialists</span>
    </div>
    <div className="flex items-center gap-3 p-3 rounded-lg border border-orange-200 dark:border-orange-800 bg-orange-50/50 dark:bg-orange-950/50">
      <span className="text-orange-600 dark:text-orange-400 text-xl">💰</span>
      <span className="text-sm font-medium">**30-day money-back guarantee** on paid plans</span>
    </div>
  </div>
</div>
...
<div className="text-center my-12 p-8 border rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950 dark:to-indigo-900 border-blue-200 dark:border-blue-800">
  <h3 className="text-2xl font-bold mb-4 text-blue-900 dark:text-blue-100">Ready to Experience Privacy-First Analytics?</h3>
  <p className="text-blue-800 dark:text-blue-200 mb-6 max-w-2xl mx-auto">
    Join thousands of websites that have already made the switch to GDPR-compliant analytics. Setup takes less than 2 minutes.
  </p>
  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
    <a href="https://app.databuddy.cc/register" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors shadow-lg hover:shadow-xl transform hover:scale-105">
      🚀 Start Free Trial - No Credit Card Required
    </a>
    <span className="text-sm text-blue-700 dark:text-blue-300">or</span>
    <a href="/demo" className="inline-flex items-center justify-center px-6 py-3 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors">
      📊 View Live Demo →
    </a>
  </div>
</div>
...
Our privacy experts are here to help! Contact us at [privacy@databuddy.cc](mailto:privacy@databuddy.cc) or check out our [Privacy Policy](/privacy) for detailed information.
</Callout> 