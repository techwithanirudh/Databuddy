...
<CodeBlock 
  language="http"
  code="GET /v1/websites/{website_id}/analytics"
/>
...
<CodeBlock 
  language="http"
  code="GET /v1/websites/{website_id}/realtime"
/>
...
<CodeBlock 
  language="http"
  code="GET /v1/websites/{website_id}/events"
/>
...
<CodeBlock 
  language="http"
  code="GET /v1/websites/{website_id}"
/>
...
<CodeBlock 
  language="http"
  code="POST /v1/websites/{website_id}/assistant/chat"
/>
