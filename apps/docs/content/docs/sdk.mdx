...
Track custom business events using the global API:
...
<button onclick="trackSignup('pro')">Upgrade to Pro</button>
<button onclick="trackFeatureUsage('export')">Export Data</button>
```
