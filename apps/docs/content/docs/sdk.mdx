...
<Callout type="info">
  **SDK Version**: Defaults to the version in `package.json` | **API**:
  basket.databuddy.cc | **CDN**: app.databuddy.cc
</Callout>
...
<Accordion title="trackScrollDepth (default: false)">
  ...
  milestones). ```tsx // Example: Enabling Scroll Depth tracking
  <Databuddy
    clientId="your-client-id"
    trackScrollDepth={true}
  />
  // Script tag: data-track-scroll-depth="true" ``` **Events tracked**:
...
<Accordion title="trackEngagement (default: false)">
  ...
  ```tsx // Example: Enabling Engagement tracking
  <Databuddy
    clientId="your-client-id"
    trackEngagement={true}
  />
  // Script tag: data-track-engagement="true" ``` **Events tracked**:
  `page_exit` (with engagement metrics), potentially custom events.
</Accordion>

<Accordion title="trackExitIntent (default: false)">
  Detects when a user's mouse movement suggests they are about to leave the
  page. ```tsx // Example: Enabling Exit Intent tracking
  <Databuddy
    clientId="your-client-id"
    trackExitIntent={true}
  />
  // Script tag: data-track-exit-intent="true" ``` **Events tracked**: Adds
...
<Accordion title="trackInteractions (default: false)">
  ...
  ```tsx // Example: Enabling Interaction tracking
  <Databuddy
    clientId="your-client-id"
    trackInteractions={true}
  />
  // Script tag: data-track-interactions="true" ``` **Events tracked**:
...
<Accordion title="trackBounceRate (default: false)">
  ...
  page. ```tsx // Example: Enabling Bounce Rate tracking
  <Databuddy
    clientId="your-client-id"
    trackBounceRate={true}
  />
  // Script tag: data-track-bounce-rate="true" ``` **Events tracked**: Adds
...
<Accordion title="trackHashChanges (default: false)">
  ...
  hash-based routing. ```tsx // Example: Enabling Hash Change tracking
  <Databuddy
    clientId="your-client-id"
    trackHashChanges={true}
  />
  // Script tag: data-track-hash-changes="true" ``` **Events tracked**: Can
...
<Accordion title="clientSecret (Server-Side Only)">
  ...
  server-to-server event tracking. ```tsx // Example: Server-side or secure
  environment usage
  <Databuddy
    clientId="your-client-id"
...
<Accordion title="waitForProfile (Advanced)">
  ...
  asynchronously and need it attached to initial events. ```tsx // Example:
  Enabling waitForProfile
  <Databuddy
    clientId="your-client-id"
    waitForProfile={true}
  />
...
<Accordion title="sdk and sdkVersion (Advanced)">
  ...
  needed for standard web usage. ```tsx // Example: Overriding SDK metadata
  (rarely needed)
  <Databuddy
    clientId="your-client-id"
